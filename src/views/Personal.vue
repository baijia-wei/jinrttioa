...
@Component({
  components: { NavigateBar, Listbar }
})
export default class Personal extends Vue {
  ...
  @Provide() moment: any = moment;
  @Provide() jsonStr: any;
  @Provide() userJson: any;

  mounted() {
    this.drawChart();
  }
  drawChart() {
    this.jsonStr = localStorage.getItem("userInfo") || "";

    this.userJson = JSON.parse(this.jsonStr);
    (this as any)
      .$axios({
